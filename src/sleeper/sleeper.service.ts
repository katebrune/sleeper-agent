...
export class SleeperService {
  ...
  async findUser(args: FindUserArgs): Promise<SleeperUser> {
    const observable = this.httpService
      .get<SleeperUser>(`https://api.sleeper.app/v1/user/${args.username}`)
  ...
  async findLeagues(args: FindLeaguesArgs): Promise<SleeperLeague[]> {
    const observable = this.httpService
      .get<
        SleeperLeague[]
      >(`https://api.sleeper.app/v1/user/${args.user_id}/leagues/nfl/2025`)
      .pipe(map((response) => response.data));
    return await lastValueFrom(observable);
  }
  ...
  async findRosters(args: FindRostersArgs): Promise<SleeperRoster[]> {
    const observable = this.httpService
      .get<
        SleeperRoster[]
      >(`https://api.sleeper.app/v1/league/${args.league_id}/rosters`)
      .pipe(map((response) => response.data));
    return await lastValueFrom(observable);
  }
  ...
  async findMatchups(args: FindMatchupsArgs): Promise<SleeperMatchup[]> {
    const observable = this.httpService
      .get<
        SleeperMatchup[]
      >(`https://api.sleeper.app/v1/league/${args.league_id}/matchups/${args.week}`)
      .pipe(map((response) => response.data));
    return await lastValueFrom(observable);
  }
  ...
  async findNflState(): Promise<SleeperNflState> {
    const observable = this.httpService
      .get<SleeperNflState>(`https://api.sleeper.app/v1/state/nfl`)
      .pipe(map((response) => response.data));
    return await lastValueFrom(observable);
  }
