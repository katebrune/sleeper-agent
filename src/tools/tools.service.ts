...
export class ToolsService {
    ...
    constructor(
        ...
        this.tools.set(this.getSleeperUserInfoTool.name, this.getSleeperUserInfoTool);
        ...
        this.tools.set(this.getSleeperMatchupsTool.name, this.getSleeperMatchupsTool);
    }
    ...
    runTool(toolCall: OpenAI.Chat.Completions.ChatCompletionMessageToolCall, userMessage: string) {
        const input = {
            userMessage,
