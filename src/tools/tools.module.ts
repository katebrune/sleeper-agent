...
@Module({
    ...
    controllers: [],
    providers: [ToolsService, SleeperService, LowDBService, GetSleeperUserInfoTool, GetSleeperLeaguesTool, GetSleeperRostersTool, GetSleeperPlayersTool, GetNflStateTool, GetSleeperMatchupsTool],
